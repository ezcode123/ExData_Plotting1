...
## Make line plot of Global Active Power by time

outfile <- "./graphproject1/code/ExData_Plotting1/plot2.png"
png(outfile, type=c("windows"),width=480, height=480)   
plot(plotdata$datetime,plotdata$Global_active_power, ylab = "Global Active Power (kilowatts)", 
     xlab = "", type = "l")
dev.off()
